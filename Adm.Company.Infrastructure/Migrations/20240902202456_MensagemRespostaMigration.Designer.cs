...
namespace Adm.Company.Infrastructure.Migrations
{
    ...
    [Migration("20240902202456_MensagemRespostaMigration")]
    partial class MensagemRespostaMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Adm.Company.Domain.Entities.Atendimento", b =>
                {
                    ...
                    b.Property<Guid?>("UsuarioFinalizadoId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Adm.Company.Domain.Entities.Atendimento", b =>
                {
                    ...
                    b.HasOne("Adm.Company.Domain.Entities.Usuario", "UsuarioFinalizado")
                        .WithMany()
